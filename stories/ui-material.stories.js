...
tooltipButton.add('Default', () => {
  ...
  const placement = select('placement', [null, 'bottom-end', 'bottom-start', 'bottom', 'left-end', 'left-start', 'left', 'right-end', 'right-start', 'right', 'top-end', 'top-start', 'top'], null);
  ...
  const button = <Components.TooltipButton title={title}
                                           titleId={titleId}
...
.add('Icon', () => {
  ...
  const button = <Components.TooltipButton title="Click button to continue"
                                           type="icon"
                                           icon="MaterialIcon1"
  />;
...
.add('Button', () => {
  ...
  const button = <Components.TooltipButton title="Click me"
                                           type="button"
  />;
...
.add('Other', () => {
  ...
  const button = <Components.TooltipButton title="Explanation of static text">
    Hover over static text
