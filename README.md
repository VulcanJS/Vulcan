...
### Development
Check out the [Latest Developer Docs](http://docs.telescopeapp.org/docs).
#### Install
You can clone *this* repo (and then run `npm install` and `meteor`) if you need access to the full codebase. This is only recommended if you want to have easy access to the codebase for reference purposes, or would like to submit PRs back to the project.
...
#### Contributing
Telescope has a lot of potential, but like all open-source projects it can only thrive if enough people contribute to it. That's where you come in! Read this [short guide to learn how you can help with Telescope](http://docs.telescopeapp.org/docs/contributing).
