...
const enhanceUsersFormWWithPassword = (usersFormComponentName = 'VulcanBackofficeUsersForm') => {
  ...
  if (!BareUsersForm) throw new Error(`Error: ${usersFormComponentName} component is not defined. vulcan:backoffice-users needs a backoffice to be set using vulcan:backoffice.`);
