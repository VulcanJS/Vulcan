...
import { withCurrentUser, withList, getSetting, Components, getRawComponent, replaceComponent } from 'meteor/vulcan:core';

class CustomPostsDailyList extends getRawComponent('PostsDailyList') {
...
CustomPostsDailyList.propTypes = {
  currentUser: PropTypes.object,
  days: PropTypes.number,
  increment: PropTypes.number
};

CustomPostsDailyList.defaultProps = {
...
const options = {
  collection: Posts,
  queryName: 'CustomPostsDailyListQuery',
  fragmentName: 'PostsList',
  limit: 0,
};

replaceComponent('PostsDailyList', CustomPostsDailyList, withCurrentUser, [withList, options]);
