...
describe('vulcan:core/container/mutations', () => {
  ...
  describe('common', () => {
    test('export hooks and hocs', () => {
      expect(useCreateOld).toBeInstanceOf(Function);
      expect(useUpdateOld).toBeInstanceOf(Function);
      expect(useUpsertOld).toBeInstanceOf(Function);
      expect(useDeleteOld).toBeInstanceOf(Function);
      expect(withCreate).toBeInstanceOf(Function);
      expect(withUpdateOld).toBeInstanceOf(Function);
      expect(withUpsertOld).toBeInstanceOf(Function);
      expect(withDeleteOld).toBeInstanceOf(Function);
    });
    test('pass down props', () => {
      const CreateComponent = withCreate(defaultOptions)(TestComponent);
      const UpdateComponent = withUpdateOld(defaultOptions)(TestComponent);
      const UpsertComponent = withUpsertOld(defaultOptions)(TestComponent);
      const DeleteComponent = withDeleteOld(defaultOptions)(TestComponent);
