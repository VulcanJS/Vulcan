...
export class AccountsForm extends Component {
  ...
  render() {
    const { oauthServices, fields, buttons, messages, ready = true, className, classes } = this.props;

    return (
      <form ref={ref => (this.form = ref)} className={classNames(className, 'accounts-ui', { ready: ready })} noValidate>
