...
const MuiInput = createReactClass({
  ...
  render: function () {
    ...
    let element = <Typography variant={variant} color={color} className={classes.inputRoot}>
    ...
    return (
      <MuiFormControl {...this.getFormControlProperties()} shrinkLabel={true} htmlFor={this.getId()}>
        {element}
