...
class Datatable extends PureComponent {
  ...
  render() {
    if (this.props.data) {
      ...
      const DatatableWithMulti = compose(withMultiOld(listOptions))(Components.DatatableContents);
...
const getColumns = (columns, results, data) => {
  if (columns) {
    ...
    // note: withMultiOld HoC also passes a prop named data, but in this case
