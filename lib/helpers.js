...
trackEvent = function(event, properties, userToNotify){
	...
	if(typeof userToNotify !== 'undefined'){
		addNotification(userToNotify, event, properties)
	}
}

addNotification = function(user, event, properties){
	console.log('adding new notification for:'+getDisplayName(user)+', for event:'+event);
	console.log(user);
