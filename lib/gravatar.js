...
Gravatar = {
  getGravatar: function(user, options) {
    if(user.email_hash){
      ...
      return 'http://graph.facebook.com/' + user.services.facebook.id + '/picture/?width=80&height=80'; //for the oauth-login avatar, diff for diff oauth, maybe it could be better
    }
  }
}