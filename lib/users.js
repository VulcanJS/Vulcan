...
getUserName = function(user){
  if(user.services.twitter) {
    ...
    return user.username || getProperty(user, 'services.facebook.name');
  }
}
...
getFacebookName = function(user){
  ...
  if(checkNested(user, 'profile', 'facebook')){
...
getGitHubName = function(user){
  // return github name provided by user, or else the one used for twitter login
