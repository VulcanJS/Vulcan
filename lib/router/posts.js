...
PostsCategoriesController = PostsListController.extend({
  view: 'categories',
});


PostsHealthController = PostsListController.extend({
  view: 'health',
});
...
Meteor.startup(function () {
  ...
  //Health & Fitness
  Router.route('/health/:limit?', {
    name: 'posts_health',
    controller: PostsHealthController
  });
